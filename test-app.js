...
hand.addCard(deck.drawMultiple(43));
...
const cardstoPlay = hand.getCards();
for (const card of cardstoPlay) {
  hand.playCard(card, discardPile);
}
console.log("Discard pile after playing cards from hand:");
console.log(discardPile.getCards());

deck.reshuffleDiscardPile(discardPile);
console.log("Deck after reshuffling the discard pile back into it:");
console.log(deck.getCards());
